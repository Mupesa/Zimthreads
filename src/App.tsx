...
const routeSeo: Record<string, {
  ...
  "/": {
    title: "Zimthreads | Premium Sneaker Care & Custom Streetwear Mauritius",
    description:
  ...
  "/services": {
    title: "Sneaker Cleaning & Restoration Services Mauritius | Zimthreads",
    description:
  ...
  "/shop": {
    title:
      "Shop Custom Streetwear & Sneaker Care Products | Zimthreads Mauritius",
    description:
      "Browse bespoke Zimthreads streetwear, premium heavyweight hoodies, and specialty sneaker cleaning supplies crafted in Mauritius.",
    canonical: "https://zimthreads.online/shop",
  },
  "/booking": {
    title: "Book Sneaker Cleaning Session | Zimthreads Mauritius",
    description:
  ...
  "/blog": {
    title:
      "Zimthread Journal | Sneaker Care Tips & Streetwear Culture Mauritius",
    description:
      "Expert shoe care advice, suede protection guides, midsole un-yellowing tips, and sneaker culture articles from the Zimthreads team in Mauritius.",
    canonical: "https://zimthreads.online/blog",
  },
  "/about": {
    title: "About Zimthreads Mauritius | Sneaker Restoration & Atelier Craft",
    description:
  ...
  "/contact": {
    title: "Contact & Drop-Off Locations Mauritius | Zimthreads",
    description:
      "Get in touch with Zimthreads Mauritius. Call or WhatsApp +230 5513 2614, arrange drop-off and collection across Mauritius, or inquire about custom apparel.",
...
function AppRoutes() {
  ...
  if (isAdmin) {
    return (
      <>
        <SEOHead
          title="Admin Dashboard | Zimthreads"
          description="Internal management dashboard for Zimthreads"
          noindex={true}
        />
        <Dashboard />
        <ToastContainer />
